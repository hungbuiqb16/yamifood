...
<head>
  ...
  <!-- mycss-->
  <link rel="stylesheet" href="admin/dist/css/mystyle.css">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('list.booking') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('addpreview') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Preview</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('listpreview') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Preview</p>
                </a>
              </li>
