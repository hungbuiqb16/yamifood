        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20">{{$value->date}}</div>
                      </td>
                    </tr>
                    @endforeach
                    </tbody>
              ...
              <div class="card-footer clearfix">
                <a href="javascript:void(0)" class="btn btn-sm btn-info float-left">Place New Booking</a>
                <a href="{{route('list.booking')}}" class="btn btn-sm btn-secondary float-right">View All Bookings</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
          ...
          <div class="col-md-4">
            ...
            <div class="card">
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  ...
                  <li class="item">
                    <div class="product-img">
                      <img src="uploads/products/{{$value->image}}" alt="Product Image" class="img-size-50">
                    </div>
                    <div class="product-info">
                      <a href="javascript:void(0)" class="product-title">{{$value->name}}
                        <span class="badge badge-danger float-right">${{$value->price}}</span></a>
              ...
              <!-- /.card-body -->
              <div class="card-footer text-center">
                <a href="{{route('listproduct')}}" class="uppercase">View All Products</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
